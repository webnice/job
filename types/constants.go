...
const (
	...
	// EventBufLength Размер буфера событий.
	...
	// DefaultKillTimeout Время ожидания остановки процесса ForkWorker перед отправкой не игнорируемого
	// сигнала KILL процессу.
